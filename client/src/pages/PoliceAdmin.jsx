...
const NakaHome = () => {
  return (
    <div>
        ...
        <div className='flex flex-row flex-wrap py-6 gap-6'>
            <h1 className='w-full text-white text-[24px]'>Reports</h1>
            <CountBox 
            title="Officers"
            value="12"
            />
            ...
            value="18"
            />
            <h1 className='w-full text-white text-[24px]'>Active Officers</h1>
