  ...
  return (
    <div>
      <div className='flex justify-between w-full'>
        ...
        <div>
            <h2 className='flex flex-col text-white text-[30px] font-bold mt-10'>Add New Alert</h2>
        <div className='flex flex-col'>
      <FormField
            labelName="Vehicle Number"
            placeholder="HR00XX0000"
            inputType="text"
            value={''}
            handleChange={()=>{}}
          />
          <FormField
            labelName="Indentification Details"
