    ...
    return (
        <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
            <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]'>
                <input type="text" placeholder='Search For Comapaign' className='flex w-full font-epilogue font-normal text-[14px] palceholder:text-[#4b5264] text-white bg-transparent outline-none' />
            ...
            <div className='sm:flex hidden flex-row justify-end  gap-4'>
                ...
                >
                    <div className=' w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer'>
                        <img src={thirdweb} alt="" className='w-[60%] h-[60%] object-contain' />
                    </div>
                </Link>
            ...
            <div className='sm:hidden flex justify-between items-center relative'>
                ...
                <div className={`absolute top-[60px] left-0 right-0 bg-[#1c1c24] z-10 shadow-secodary py-4 
